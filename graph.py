import sys
sys.path.insert(0, '/home/user/gravelle/tau-2.26.3/tools/src/perfexplorer') # location of src
...
def loadFromFiles():
	inputs = ArrayList()
	inputs.add(loadFile("mkFit_sampling_e10000_t10_2017-11-27T01:29:09Z.ppk"))
	return inputs
...
def loadFromDB():
	Utilities.setSession("hep")
	inputs.add(loadDB("mkFit_sampling", "", "mkFit_sampling_e10000_t10_2017-11-27T01:29:09Z"))
	return inputs
