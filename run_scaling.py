...
if machine == 'Talapas':
	PATH=('PATH', '/projects/hpcl/bgravell/mictest_sampling/mkFit/')
	env[PATH[0]] = PATH[1] + ':' + env[PATH[0]]
	LD_PATH = ('LD_LIBRARY_PATH', '/projects/hpcl/bgravell/mictest_sampling/')
	env[LD_PATH[0]] = LD_PATH[1] + ':' + env[LD_PATH[0]]
